...
var GenerarCodeQRComponent = /** @class */ (function () {
    function GenerarCodeQRComponent(_modal, _storage, socialSharing, clipboard, _comp) {
        this._modal = _modal;
    ...
    GenerarCodeQRComponent.prototype.compartirDireccion = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.socialSharing.share('', '', imagenB64, this.textoShare);
                return [2 /*return*/];
            });
        });
    };
